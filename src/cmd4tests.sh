...
############################## Live ##############################
python3 main.py --llm_id gpt-4o-mini --modality evaluation-simulation --max_new_tokens 512
...
python3 main.py --llm_id gpt-4o-mini --modality evaluation-routing --max_new_tokens 512
